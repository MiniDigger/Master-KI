 ...
 * </pre>
 */
@XmlAccessorType(XmlAccessType.FIELD) @XmlType(name = "DisconnectMessageType", propOrder = { "name",
		"errorCode" }) public class DisconnectMessageType {

	@XmlElement(required = true) protected String name;
	@XmlElement(required = true) @XmlSchemaType(name = "string") protected ErrorType errorCode;
