 ...
 * </pre>
 */
@XmlAccessorType(XmlAccessType.FIELD) @XmlType(name = "boardType", propOrder = { "row", "shiftCard",
		"forbidden" }) public class BoardType {

	@XmlElement(required = true) protected List<Row> row;
	@XmlElement(required = true) protected CardType shiftCard;
	 ...
	 * </pre>
	 */
	@XmlAccessorType(XmlAccessType.FIELD) @XmlType(name = "", propOrder = { "col" }) public static class Row {

		@XmlElement(required = true) protected List<CardType> col;
		@XmlAttribute(name = "OptionalAttirbute") protected String optionalAttirbute;
